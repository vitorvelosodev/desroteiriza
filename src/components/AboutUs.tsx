      ...
      <Container>
        <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
          <Image
            ...
            className="mx-auto aspect-square overflow-hidden object-cover object-center shadow-2xl sm:w-full lg:order-last"
            src={weAreCapixabas}
          />
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <h2 className="mb-4 font-title text-3xl font-bold tracking-tighter text-tertiary sm:text-5xl">
